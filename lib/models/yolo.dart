...
import 'package:yolo_flutter/models/nms.dart';
...
class YoloModel {
  ...
  (List<int>, List<List<double>>, List<double>) postprocess(
    ...
    debugPrint(
        'NMS time: ${DateTime.now().millisecondsSinceEpoch - nmsTimeStart} ms, Classe $classes');
  ...
  // Essa função combina duas etapas: a inferência e o pós-processamento
